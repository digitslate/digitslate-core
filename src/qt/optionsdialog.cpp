    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DISL-light"), QVariant("light"));
    ui->theme->addItem(QString("DISL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DISL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DISL-traditional"), QVariant("trad"));
