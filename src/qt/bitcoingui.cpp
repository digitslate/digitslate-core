    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("DigitSlate") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DigitSlate address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and digitslate: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About DigitSlate"), this);
    aboutAction->setStatusTip(tr("Show information about DigitSlate"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DigitSlate"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DigitSlate addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DigitSlate addresses"));
    ...
    openAction->setStatusTip(tr("Open a digitslate: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DigitSlate help message to get a list with possible DigitSlate command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("DigitSlate client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DigitSlate network", "", count));
}
...
{
    QString strTitle = tr("DigitSlate"); // default title
