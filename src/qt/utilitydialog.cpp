    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("DigitSlate") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About DigitSlate"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  digitslate-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the DigitSlate in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DISL, 0.1 DISL, 1 DISL and 10 DISL -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://digitslatecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://digitslatecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("DigitSlate is shutting down...") + "<br /><br />" +
