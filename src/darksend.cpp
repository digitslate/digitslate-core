...
{
    if(fLiteMode) return; // ignore all DigitSlate related functionality
...
/*
    ...
    allow endless transaction that would bloat DigitSlate and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("digitslate-privatesend");
