...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DigitSlateNetwork") type = DigitSlateNetwork;
    if(strType == "DigitSlateNetworkVariable") type = DigitSlateNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DigitSlateNetwork) s = "DigitSlateNetwork";
    if(type == DigitSlateNetworkVariable) s = "DigitSlateNetworkVariable";
