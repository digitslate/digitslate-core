 ...
 *
 *   // network
 *   CDigitSlateNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.digitslate.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDigitSlateNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CDigitSlateNetwork(UniValue objIn)
    {
...
// // can be under: DigitSlateNetwork
// //   -- signature requirements : Key1(User)
// class CDigitSlateNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == DigitSlateNetwork);
//     // }
