...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("DigitSlate digitslate-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  digitslate-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitslate transaction") + "\n" +
              "  digitslate-tx [options] -create [commands]   " + _("Create hex-encoded digitslate transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded digitslate transaction
